    ...
    <div className='bg-white'>
      ...
      <div className='relative bg-gray-900'>
        ...
        <div className='relative flex flex-col items-center max-w-3xl px-6 py-32 mx-auto text-center sm:py-64 lg:px-0'>
          ...
          <p className='mt-4 text-xl text-white'>{posts.newest.slug}</p>
          <a
            href={`/articles/${posts.newest.slug}`}
        ...
        >
          <div className='relative overflow-hidden rounded-lg'>
            <div className='absolute inset-0'>
              <img
                src={
                  posts.news[0].coverImage === posts.newest.coverImage
                    ? posts.news[1].coverImage
                    : posts.news[0].coverImage
                }
                alt=''
                className='object-cover object-center w-full h-full'
              />
              ...
              <div className='relative flex flex-col items-center max-w-3xl mx-auto text-center'>
                ...
                >
                  <span className='block sm:inline'>
                    {posts.news[0].title === posts.newest.title
                      ? posts.news[1].title
                      : posts.news[0].title}
                  </span>
                </h2>
                <p className='mt-3 text-xl text-white'>
                  {posts.news[0].slug === posts.newest.slug
                    ? posts.news[1].slug
                    : posts.news[0].slug}
                </p>
                <a
        ...
        >
          <div className='relative overflow-hidden rounded-lg'>
            <div className='absolute inset-0'>
              <img
                src={
                  posts.sports[0].coverImage === posts.newest.coverImage
                    ? posts.sports[1].coverImage
                    : posts.sports[0].coverImage
                }
                alt=''
                className='object-cover object-center w-full h-full'
              />
            ...
            <div className='relative px-6 py-32 bg-gray-900 bg-opacity-75 sm:px-12 sm:py-40 lg:px-16'>
              <div className='relative flex flex-col items-center max-w-3xl mx-auto text-center'>
                ...
                >
                  <span className='block sm:inline'>
                    {posts.sports[0].title === posts.newest.title
                      ? posts.sports[1].title
                      : posts.sports[0].title}
                  </span>
                </h2>
                <p className='mt-3 text-xl text-white'>
                  {posts.sports[0].slug === posts.newest.slug
                    ? posts.sports[1].slug
                    : posts.sports[0].slug}
                </p>
                <a
